...
const ProductCard = ({ id, name, price, original_price, image_url, category }: ProductCardProps) => {
  ...
  return (
    <div className="group relative bg-card rounded-lg overflow-hidden border border-gold/10 hover:border-gold/30 transition-all duration-500 animate-fade-in">
      {/* Image */}
      <div className="relative aspect-square overflow-hidden">
        ...
        {/* Wishlist Button */}
        <button className="absolute top-3 right-3 w-8 h-8 bg-background/80 backdrop-blur-sm rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300 hover:bg-gold hover:text-background">
